...
INGREDIENT_COMBINATION_MAX_ENTRIES = int(
    os.getenv("INGREDIENT_COMBINATION_MAX_ENTRIES", "500")
)
INGREDIENT_CACHE_TTL = int(
    os.getenv("INGREDIENT_CACHE_TTL", str(86400 * 30))
)  # 30 days default
INGREDIENT_SIMILARITY_THRESHOLD = float(
    os.getenv("INGREDIENT_SIMILARITY_THRESHOLD", "0.8")
)
MIN_INGREDIENT_CONFIDENCE_TO_CACHE = int(
    os.getenv("MIN_INGREDIENT_CONFIDENCE_TO_CACHE", "70")
)

# Progressive Analysis Configuration
PROGRESSIVE_ANALYSIS_TIMEOUT = int(
    os.getenv("PROGRESSIVE_ANALYSIS_TIMEOUT", "300")
)  # 5 minutes default
PROGRESSIVE_ANALYSIS_MAX_THREADS = int(
    os.getenv("PROGRESSIVE_ANALYSIS_MAX_THREADS", "4")
)
PROGRESSIVE_ANALYSIS_WEBSOCKET_ENABLED = (
    os.getenv("PROGRESSIVE_ANALYSIS_WEBSOCKET_ENABLED", "True") == "True"
)
...
CONFIDENCE_ROUTING_CACHE_TTL = int(
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "api.security.token_blacklist.DatabaseBackedJWTAuthentication",
    ],
...
MALWARE_SCAN_CACHE_TIMEOUT = int(
    os.getenv("MALWARE_SCAN_CACHE_TIMEOUT", 86400)
)  # 24 hours
