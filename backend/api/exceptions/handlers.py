...
from .custom_exceptions import (
    NutritionAIException, TokenExpiredException, InvalidTokenException,
...
def _format_error_response(exc: Exception, response: Response, request) -> Dict[str, Any]:
...
def _format_validation_error(exc: ValidationError) -> Dict[str, Any]:
    ...
    if isinstance(detail, dict):
        ...
        first_error = errors[first_field][0] if errors[first_field] else 'Validation failed'
