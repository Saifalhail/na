...
def send_email_notification(self, notification_id):
    ...
    try:
        ...
        template_base = template_map.get(notification.type, 'emails/generic_notification')
        ...
        try:
            ...
            if notification.retry_count < self.max_retries:
                raise self.retry(countdown=60 * (2 ** notification.retry_count))  # Exponential backoff
        except Notification.DoesNotExist:
            pass
...
def send_welcome_email(user_id):
    ...
    try:
        ...
        context = {
            ...
            'site_name': getattr(settings, 'SITE_NAME', 'Nutrition AI'),
            'site_url': getattr(settings, 'FRONTEND_URL', 'https://nutritionai.com'),
            'support_email': getattr(settings, 'SUPPORT_EMAIL', 'support@nutritionai.com'),
        }
