...
class AccountAdapterTestCase(TestCase):
    ...
    def test_save_user_with_form_data(self):
        ...
        with patch.object(self.adapter.__class__.__bases__[0], 'save_user') as mock_super:
...
class SocialAccountAdapterTestCase(TestCase):
    ...
    def _create_mock_sociallogin(self, provider='google', is_existing=False, extra_data=None):
    ...
    def test_pre_social_login_google_new_user(self):
        ...
        request = self.factory.get('/')
        sociallogin = self._create_mock_sociallogin(provider='google', is_existing=False)
    ...
    def test_save_user_with_complete_data(self):
        ...
        self.assertTrue(hasattr(saved_user, 'profile'))
        self.assertEqual(saved_user.profile.social_avatar_url, 'https://example.com/avatar.jpg')
    ...
    def test_populate_user_google_provider(self):
        ...
        with patch.object(self.adapter.__class__.__bases__[0], 'populate_user') as mock_super:
            mock_super.return_value = user
