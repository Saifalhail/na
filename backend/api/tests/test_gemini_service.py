                ...
                with patch("google.generativeai.GenerativeModel") as mock_model_class:
                    with patch("django.core.cache.cache") as mock_cache:
                        ...
                        mock_cache.get.side_effect = (
                            None  # Clear any side effects from previous tests
                        )
                        mock_cache.set.return_value = None
                        mock_cache.set.side_effect = (
                            None  # Clear any side effects from previous tests
                        )
                        ...
                        self.service.use_cache = (
                            False  # Disable caching for tests by default
                        )
...
```"""
    ...
    def test_calculate_nutrition_success(self):
        ...
        result = self.service.calculate_nutrition_from_ingredients(
            ingredients, serving_size=2
        )
    ...
    def test_caching_functionality(self):
        ...
        with patch.object(self.service, "use_cache", True):
            ...
            try:
                ...
                assert (
                    self.mock_model.generate_content.call_count == 1
