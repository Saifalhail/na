...
from api.models import (
    APIUsageLog, NutritionData, NutritionalInfo, 
    FavoriteMeal, RecipeIngredient, Meal, FoodItem
)
...
class APIUsageLogModelTest(TestCase):
    ...
    def test_error_logging(self):
        ...
        self.assertEqual(log.error_message, 'Invalid meal data: missing required field "name"')
...
class NutritionalInfoModelTest(TestCase):
    ...
    def test_string_representation(self):
        ...
        self.assertEqual(str(food_nutrition), f"Nutritional info for food: {self.food_item}")
...
class RecipeIngredientModelTest(TestCase):
    ...
    def test_nutrition_data_relationship(self):
        ...
        self.assertEqual(
            list(self.nutrition_data.ingredients.all()),
            ingredients
        )
    ...
    def test_cascade_delete(self):
        ...
        self.assertEqual(
            RecipeIngredient.objects.filter(nutrition_data_id=nutrition_id).count(),
            0
        )