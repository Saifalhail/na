    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plan_type', models.CharField(choices=[('free', 'Free'), ('premium', 'Premium'), ('professional', 'Professional')], max_length=20, unique=True, verbose_name='plan type')),
                ...
                ('ai_analysis_limit', models.IntegerField(default=10, help_text='Number of AI analyses per month (-1 for unlimited)', verbose_name='AI analysis limit')),
                ('meal_storage_limit', models.IntegerField(default=100, help_text='Number of meals that can be stored (-1 for unlimited)', verbose_name='meal storage limit')),
                ('stripe_price_id', models.CharField(blank=True, help_text='Stripe price ID for this plan', max_length=255, verbose_name='Stripe price ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('stripe_subscription_id', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Stripe subscription ID')),
                ('stripe_customer_id', models.CharField(blank=True, max_length=255, verbose_name='Stripe customer ID')),
                ('status', models.CharField(choices=[('active', 'Active'), ('inactive', 'Inactive'), ('canceled', 'Canceled'), ('past_due', 'Past Due'), ('trialing', 'Trialing')], default='inactive', max_length=20, verbose_name='status')),
                ...
                ('ai_analyses_used', models.IntegerField(default=0, verbose_name='AI analyses used')),
                ('ai_analyses_reset_date', models.DateTimeField(blank=True, null=True, verbose_name='AI analyses reset date')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_type', models.CharField(choices=[('card', 'Credit/Debit Card'), ('paypal', 'PayPal'), ('bank_account', 'Bank Account')], max_length=20, verbose_name='payment type')),
                ...
                ('card_exp_month', models.IntegerField(blank=True, null=True, verbose_name='card expiry month')),
                ('card_exp_year', models.IntegerField(blank=True, null=True, verbose_name='card expiry year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('stripe_payment_intent_id', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Stripe payment intent ID')),
                ...
                ('status', models.CharField(choices=[('pending', 'Pending'), ('succeeded', 'Succeeded'), ('failed', 'Failed'), ('canceled', 'Canceled'), ('refunded', 'Refunded')], default='pending', max_length=20, verbose_name='status')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='api.subscription')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('stripe_invoice_id', models.CharField(blank=True, max_length=255, unique=True, verbose_name='Stripe invoice ID')),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('subscription', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='invoices', to='api.subscription')),
