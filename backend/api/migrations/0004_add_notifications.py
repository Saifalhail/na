    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.JSONField(
                blank=True,
                default=dict,
                help_text="Detailed preferences for different notification types",
        ...
        migrations.AddField(
            ...
            field=models.JSONField(
                ...
                verbose_name="meal reminder times",
            ),
        ),
        migrations.AddField(
            model_name="userprofile",
            ...
            field=models.BooleanField(
                default=True,
                help_text="Receive daily nutrition summary via email",
                verbose_name="email daily summary",
            ),
        ),
        migrations.AddField(
            model_name="userprofile",
            ...
            field=models.BooleanField(
                ...
                verbose_name="email weekly report",
            ),
        ),
        migrations.AddField(
            model_name="userprofile",
            ...
            field=models.BooleanField(
                default=True,
                help_text="Receive nutrition tips and recommendations via email",
                verbose_name="email nutrition tips",
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["user", "status"], name="notifications_user_status_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
            index=models.Index(
                fields=["user", "type"], name="notifications_user_type_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notification",
