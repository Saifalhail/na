...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether this device has been confirmed by entering a valid token",
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=1,
                        help_text="Number of periods before/after current time to allow",
                ...
                (
                    ...
                    models.BigIntegerField(
                        default=0,
                        help_text="Unix timestamp of when to start counting time steps",
                        verbose_name="t0",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.SmallIntegerField(
                        default=0,
                        help_text="Current drift between server and device clocks",
                        verbose_name="drift",
                    ),
                ),
                (
                    ...
                    models.BigIntegerField(
                        default=-1,
                        help_text="Timestamp of the last successfully verified token",
                        verbose_name="last token timestamp",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        help_text="Single-use backup code",
                        max_length=16,
                        unique=True,
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "used"], name="backup_code_user_id_used_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="backupcode",
