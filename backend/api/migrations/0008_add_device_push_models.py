    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device_id', models.CharField(default='unknown_device', max_length=255, help_text='Unique device identifier')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('meal_reminder', 'Meal Reminder'), ('goal_achieved', 'Goal Achieved'), ('streak_milestone', 'Streak Milestone'), ('weekly_summary', 'Weekly Summary'), ('general', 'General')], default='general', max_length=50)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('device_token', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.devicetoken')),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['user', 'status'], name='idx_push_user_status'),
                ],
            },
        ),
    ]