...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="meal",
            index=models.Index(
                fields=["user", "-consumed_at"], name="idx_meals_user_consumed"
            ),
        ),
        migrations.AddIndex(
            model_name="meal",
            index=models.Index(
                fields=["user", "-updated_at"], name="idx_meals_user_updated"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "-updated_at"], name="idx_notifications_user_upd"
            ),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "status"], name="idx_subscriptions_user_stat"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="mealitem",
            index=models.Index(
                fields=["meal", "food_item"], name="idx_meal_items_meal_food"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="invoice",
            index=models.Index(
                fields=["user", "status"], name="idx_invoices_user_status"
            ),
        ),
    ]
